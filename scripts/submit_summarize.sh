...
/n/holystore01/LABS/iaifi_lab/Users/smsharma/envs/$ENV/bin/python summarize.py --data_dir /n/holystore01/LABS/iaifi_lab/Users/smsharma/multimodal-data/data --observations_dir observations_v1 --save_filename summary_v1