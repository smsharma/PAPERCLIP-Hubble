...
# /n/holystore01/LABS/iaifi_lab/Users/smsharma/envs/$ENV/bin/python -u train.py --config ./configs/base.py --config.training.n_train_steps=10001 --config.training.warmup_steps=500 --config.optim.learning_rate=1e-6  # Fewer steps
