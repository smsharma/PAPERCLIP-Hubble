...
\definecolor{deeppurple}{rgb}{0.60,0.42,0.63}
...
Examples of images and corresponding (clipped) proposal abstracts are shown in Tab.~\ref{tab:dataset}. % \SM{Push table earlier.}
%
...
\begin{table}[h!]
  ...
  \begin{tabular}{m{3cm} m{3.2cm} m{3.2cm} m{5cm}}
      ...
      \midrule
      \centering \includegraphics[width=0.15\textwidth]{\thedatafolder/img_itt_abs_0.pdf} & \centering \scriptsize \verbatiminput{\thedatafolder/sci_itt_base_0.txt} & \centering  \scriptsize \verbatiminput{\thedatafolder/sci_itt_abs_0.txt} &  {\scriptsize \input{\thedatafolder/abs_itt_abs_0.txt}} \tabularnewline
      \midrule
      \centering \includegraphics[width=0.15\textwidth]{\thedatafolder/img_itt_abs_1.pdf} & \centering \scriptsize \verbatiminput{\thedatafolder/sci_itt_base_1.txt} & \centering  \scriptsize \verbatiminput{\thedatafolder/sci_itt_abs_1.txt} &  {\scriptsize \input{\thedatafolder/abs_itt_abs_1.txt}} \tabularnewline
      \midrule
      \centering \includegraphics[width=0.15\textwidth]{\thedatafolder/img_itt_abs_2.pdf} & \centering \scriptsize \verbatiminput{\thedatafolder/sci_itt_base_2.txt} & \centering  \scriptsize \verbatiminput{\thedatafolder/sci_itt_abs_2.txt} &  {\scriptsize \input{\thedatafolder/abs_itt_abs_2.txt}} \tabularnewline
      \midrule
      \centering \includegraphics[width=0.15\textwidth]{\thedatafolder/img_itt_abs_3.pdf} & \centering \scriptsize \verbatiminput{\thedatafolder/sci_itt_base_3.txt} & \centering  \scriptsize \verbatiminput{\thedatafolder/sci_itt_abs_3.txt} &  {\scriptsize \input{\thedatafolder/abs_itt_abs_3.txt}} \tabularnewline
      \bottomrule
  \end{tabular}
